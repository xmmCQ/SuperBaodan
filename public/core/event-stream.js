import { api, workspaceUrl } from './api-client.js?v=1';
...
export function createAgentEventStream({
  ...
  function dispatch(event) {
    ...
    const flight = request(workspaceUrl(`/api/agent/ui-payload?token=${encodeURIComponent(event.token)}`, event.workspaceId), { cache: 'no-store', timeout: 15000 });
    pending = flight;
