...
export class SkillManager {
  constructor({ agentDir, cwd, backupDir, piAdmin, env = process.env, fetchImpl = fetch, execFileImpl = execFileAsync, loadSdk = loadPiSdk, log = console }) {
  ...
  async list() {
    ...
    return {
      ...
      cliAvailable: await this.isCliAvailable(),
    };
  }
  ...
  mutateWithMaintenance(operation) {
    return this.piAdmin.withMaintenance(operation);
  }
