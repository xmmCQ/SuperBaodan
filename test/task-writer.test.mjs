...
test("新增计划必须具备合法参数", () => {
  assert.throws(() => addTaskMarkdown(source, { text: "无日期" }, "2026-08-28"), /至少需要计划日或截止日/);
  ...
  assert.throws(() => addTaskMarkdown(source, { kind: 'longterm', text: "频率错误", recurrence: "quarter" }, "2026-08-28"), /循环频率不正确/);
});
