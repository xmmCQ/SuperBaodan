...
export const layers = {
  unit: [
    ...
    'modularization', 'pi-admin', 'product-constraints', 'query-coordination', 'reading-resize',
  ...
  integration: [
    'agent-process', 'agent-contract', 'app-data-context', 'atomic-file', 'daily-record-api', 'daily-record-manager',
    ...
    'pi-sdk', 'pi-session-store', 'read-cache', 'review-regressions', 'runtime-turn-files',
  ...
  browser: [
    ...
    'p2-browser', 'project-prompt', 'prompt-images', 'reading-and-file-panel', 'reply-actions',
  ...
  desktop: ['desktop-agent-smoke', 'desktop-agent-supervision', 'desktop-draft-exit', 'desktop-longterm'],
};
